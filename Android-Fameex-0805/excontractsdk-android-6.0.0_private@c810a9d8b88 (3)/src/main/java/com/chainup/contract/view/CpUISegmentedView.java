...
public class CpUISegmentedView extends RadioGroup {
    ...
    public CpUISegmentedView(Context context, AttributeSet attrs) throws Exception {
        super(context, attrs);
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes(
                attrs, R.styleable.CpUISegmentedView,
                0, 0);

        try {

            selectedColor = attributes.getColor(R.styleable.CpUISegmentedView_selectedColor, selectedColor);
            selectedTextColor = attributes.getColor(R.styleable.CpUISegmentedView_selectedTextColor, selectedTextColor);
            unselectedColor = attributes.getColor(R.styleable.CpUISegmentedView_unselectedColor, unselectedColor);
            unselectedTextColor = attributes.getColor(R.styleable.CpUISegmentedView_unselectedTextColor, selectedColor);
            ...
            textSize = attributes.getFloat(R.styleable.CpUISegmentedView_svTextSize, 12);
            stroke = attributes.getFloat(R.styleable.CpUISegmentedView_stroke, 0.5f);
            defaultSelection = attributes.getInt(R.styleable.CpUISegmentedView_defaultSelection, defaultSelection);
            equalWidth = attributes.getBoolean(R.styleable.CpUISegmentedView_equalWidth, equalWidth);
            stretch = attributes.getBoolean(R.styleable.CpUISegmentedView_stretch, stretch);
            identifier = attributes.getString(R.styleable.CpUISegmentedView_identifier);

            CharSequence[] itemArray = attributes.getTextArray(R.styleable.CpUISegmentedView_items);
            CharSequence[] valueArray = attributes.getTextArray(R.styleable.CpUISegmentedView_values);
    ...
    private void update() {
        ...
        while (itemIterator.hasNext()) {
            ...
            if (i == 0) {
                //Left
                GradientDrawable leftUnselected = (GradientDrawable) mCtx.getResources().getDrawable(R.drawable.cp_segmented_left_option).mutate();
                leftUnselected.setStroke(twoDP, unselectedTextColor);

                leftUnselected.setColor(unselectedColor);
                GradientDrawable leftSelected = (GradientDrawable) mCtx.getResources().getDrawable(R.drawable.cp_segmented_left_option_selected).mutate();
                ...
                //Right
                GradientDrawable rightUnselected = (GradientDrawable) mCtx.getResources().getDrawable(R.drawable.cp_segmented_right_option).mutate();
                rightUnselected.setStroke(twoDP, unselectedTextColor);

                rightUnselected.setColor(unselectedColor);
                GradientDrawable rightSelected = (GradientDrawable) mCtx.getResources().getDrawable(R.drawable.cp_segmented_right_option_selected).mutate();
                ...
                //Middle
                GradientDrawable middleUnselected = (GradientDrawable) mCtx.getResources().getDrawable(R.drawable.cp_segmented_middle_option).mutate();
                ...
                GradientDrawable middleSelected = (GradientDrawable) mCtx.getResources().getDrawable(R.drawable.cp_segmented_middle_option_selected).mutate();
...
//        }
     ...
     * TypedValue
     *
     *@param unitType Reference TypedValue
     */
    ...
    /**
     * Used to set the selected value based on the value (not the cp_visible text) provided in the
