...
data class CpQuotesData(var event_rep: String = "",
                        var channel: String = "",
                        var data: Any? = "null",
                        var tick: Tick = Tick(),
                        var ts: Long = 0,
                        var status: String? = "ok" // 1563755809000
) {


    class Tick(var amount: String = "--", //Transaction volume
               var vol: String = "0", //Transaction volume
               var high: String = "--", //Maximum Price
               var low: String = "--", //Lowest price
               var rose: Double = 0.0, //Increase
               var close: String = "0", //Closing Price
               var open: String = "--", //Opening price
               var name: String = "",
