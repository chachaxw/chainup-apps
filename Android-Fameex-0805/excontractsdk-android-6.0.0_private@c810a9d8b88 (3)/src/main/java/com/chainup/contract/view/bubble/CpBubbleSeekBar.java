...
import static com.chainup.contract.view.bubble.CpBubbleSeekBar.TextPosition.BELOW_SECTION_MARK;
import static com.chainup.contract.view.bubble.CpBubbleSeekBar.TextPosition.BOTTOM_SIDES;
import static com.chainup.contract.view.bubble.CpBubbleSeekBar.TextPosition.SIDES;
 ...
 */
public class CpBubbleSeekBar extends View {
    ...
    private Drawable mTrackDrawable; // color of right-track
    private Drawable mSecondTrackDrawable; // color of left-track
    ...
    private boolean isHideBubble; // cp_hide bubble
    ...
    private CpBubbleConfigBuilder mConfigBuilder; // config attributes
    private Context mContext;

    private String symbol = "X";

    public CpBubbleSeekBar(Context context) {
        this(context, null);
        mContext = context;
    }

    public CpBubbleSeekBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        mContext = context;
    }

    public CpBubbleSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mContext = context;

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SlBubbleSeekBar, defStyleAttr, 0);
        mMin = a.getFloat(R.styleable.SlBubbleSeekBar_bsb_min, 0.0f);
        mMax = a.getFloat(R.styleable.SlBubbleSeekBar_bsb_max, 100.0f);

        String configSymbol = a.getString(R.styleable.SlBubbleSeekBar_bsb_symbol);
        if(!TextUtils.isEmpty(configSymbol)){
            symbol = configSymbol;
        }
        mProgress = a.getFloat(R.styleable.SlBubbleSeekBar_bsb_progress, mMin);
        isFloatType = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_is_float_type, false);
        mTrackSize = a.getDimensionPixelSize(R.styleable.SlBubbleSeekBar_bsb_track_size, dp2px(2));
        mSecondTrackSize = a.getDimensionPixelSize(R.styleable.SlBubbleSeekBar_bsb_second_track_size,
                mTrackSize + dp2px(2));
        mThumbRadius = a.getDimensionPixelSize(R.styleable.SlBubbleSeekBar_bsb_thumb_radius,
                mSecondTrackSize + dp2px(2));
        mThumbRadiusOnDragging = a.getDimensionPixelSize(R.styleable.SlBubbleSeekBar_bsb_thumb_radius_on_dragging,
                mSecondTrackSize * 2);
        mSectionCount = a.getInteger(R.styleable.SlBubbleSeekBar_bsb_section_count, 10);
        mTrackColor = a.getColor(R.styleable.SlBubbleSeekBar_bsb_track_color,
                ContextCompat.getColor(context, R.color.colorPrimary));
        mTrackDrawable = a.getDrawable(R.styleable.SlBubbleSeekBar_bsb_track_drawable);
        mSecondTrackColor = a.getColor(R.styleable.SlBubbleSeekBar_bsb_second_track_color,
                ContextCompat.getColor(context, R.color.colorAccent));

        mSecondTrackDrawable = a.getDrawable(R.styleable.SlBubbleSeekBar_bsb_second_track_drawable);

        mThumbColor = a.getColor(R.styleable.SlBubbleSeekBar_bsb_thumb_color, mSecondTrackColor);
        mThumbDrawable = a.getDrawable(R.styleable.SlBubbleSeekBar_bsb_thumb_drawable);
        isShowSectionText = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_show_section_text, false);
        mSectionTextSize = a.getDimensionPixelSize(R.styleable.SlBubbleSeekBar_bsb_section_text_size, sp2px(14));
        mSectionTextColor = a.getColor(R.styleable.SlBubbleSeekBar_bsb_section_text_color, ContextCompat.getColor(context, R.color.normal_text_color));
        isSeekStepSection = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_seek_step_section, false);
        isSeekBySection = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_seek_by_section, false);
        int pos = a.getInteger(R.styleable.SlBubbleSeekBar_bsb_section_text_position, NONE);
        if (pos == 0) {
        ...
        mSectionTextInterval = a.getInteger(R.styleable.SlBubbleSeekBar_bsb_section_text_interval, 1);
        isShowThumbText = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_show_thumb_text, true);
        mThumbTextSize = a.getDimensionPixelSize(R.styleable.SlBubbleSeekBar_bsb_thumb_text_size, sp2px(14));
        mThumbTextColor = a.getColor(R.styleable.SlBubbleSeekBar_bsb_thumb_text_color, mSecondTrackColor);
        mBubbleColor = a.getColor(R.styleable.SlBubbleSeekBar_bsb_bubble_color, mSecondTrackColor);
        mBubbleTextSize = a.getDimensionPixelSize(R.styleable.SlBubbleSeekBar_bsb_bubble_text_size, sp2px(10));
        mBubbleTextColor = a.getColor(R.styleable.SlBubbleSeekBar_bsb_bubble_text_color, Color.WHITE);
        isShowSectionMark = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_show_section_mark, false);
        isAutoAdjustSectionMark = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_auto_adjust_section_mark, false);
        isShowProgressInFloat = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_show_progress_in_float, false);
        int duration = a.getInteger(R.styleable.SlBubbleSeekBar_bsb_anim_duration, -1);
        mAnimDuration = duration < 0 ? 200 : duration;
        isTouchToSeek = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_touch_to_seek, false);
        isAlwaysShowBubble = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_always_show_bubble, false);
        duration = a.getInteger(R.styleable.SlBubbleSeekBar_bsb_always_show_bubble_delay, 0);
        mAlwaysShowBubbleDelay = duration < 0 ? 0 : duration;
        isHideBubble = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_hide_bubble, false);
        isRtl = a.getBoolean(R.styleable.SlBubbleSeekBar_bsb_rtl, false);
        a.recycle();
        ...
        //MIUI prohibits developers from using TYPE_ TOAST, Android 7.1.1 vs. TYPE_ More stringent use of TOAST
        if (CpBubbleUtils.isMIUI() || Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1) {
    ...
    private void calculateRadiusOfBubble() {
        ...
        //Calculate the width of the text to be displayed when sliding into the bubbles at both ends, and take the maximum value as the radius of the bubble for comparison
        String text;
    ...
    private void initSectionTextArray() {
        ...
        for (int i = 0; i <= mSectionCount; i++) {
            ...
            mSectionTextArray.put(i, isFloatType ? float2String(sectionValue) : (int) sectionValue + symbol);
        }
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (isShowThumbText) {
            ...
            height += mRectText.height(); //If real-time progress is displayed, add the progress text height and interval to the original basis
        }
        if (isShowSectionText && mSectionTextPosition >= BOTTOM_SIDES) { //If the Section value is displayed under the track, the larger value is taken for comparison
     ...
     * <p>
     *Bubble BubbleView is actually a view dynamically added through WindowManager, so the only positional connection to the SeekBar is their on-screen
     *Absolute coordinates.
     *First, calculate the center coordinates of the BubbleView when the progress mProgress is mMin (mBubbleCenterRawSolidX, mBubbleCenterRawSolidY),
     *Then incrementally calculate the abscissa mBubbleCenterRawX based on the progress, and dynamically set LayoutParameter. x to achieve bubble following sliding movement.
     */
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isShowTextBelowSectionMark || isShowSectionMark) {
            ...
            if (mCircle == null) {
                mCircle = getBitmapDraw(mTrackDrawable, dp2px(20));
            }

            if (mSecondCircle == null) {
                mSecondCircle = getBitmapDraw(mSecondTrackDrawable, dp2px(20));
            }
            ...
            for (int i = 0; i <= mSectionCount; i++) {
                ...
                if (isRtl) {
                    if (x_ <= junction) {
                     //   canvas.drawCircle(x_, yTop, r, mPaint);
                        canvas.drawBitmap(mCircle, x_ - dp2px(10)/2, yTop - mCircle.getHeight()/2, mPaint);
                    } else {
                        canvas.drawBitmap(mSecondCircle, x_ - dp2px(10)/2, yTop - mSecondCircle.getHeight()/2, mPaint);
                    }
                } else {
                    if (x_ <= junction) {
                        canvas.drawBitmap(mSecondCircle, x_ - dp2px(10)/2, yTop- mSecondCircle.getHeight()/2, mPaint);
                ...
                if (isShowTextBelowSectionMark) {
                    mPaint.setColor(mContext.getResources().getColor(R.color.normal_text_color));
        ...
        if (mThumbBitmap == null) {
            mThumbBitmap = getBitmapDraw(mThumbDrawable, dp2px(26));
        }
        canvas.drawBitmap(mThumbBitmap, mThumbCenterX - dp2px(26)/2, yTop - mThumbBitmap.getHeight()/2, mPaint);
    ...
    private Bitmap getBitmapDraw(Drawable drawable, int range) {
        if (drawable == null) {
            return null;
        }
        int width;
...
//            }
    ...
    private void autoAdjustSection() {
        ...
        boolean onSection = x_ == x; //At the section, do not perform valueAnim to optimize performance
        ...
        if (!onSection) {
            ...
            valueAnim.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(ValueAnimator animation) {
                    ...
                    if (mProgressListener != null) {
                        mProgressListener.onProgressChanged(CpBubbleSeekBar.this, getProgress(), getProgressFloat());
                    }
                }
            });
        }
        ...
        animatorSet.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mProgressListener != null) {
                    mProgressListener.getProgressOnFinally(CpBubbleSeekBar.this, getProgress(), getProgressFloat());
                }
            }
    ...
    private void hideBubble() {
        ...
        mBubbleView.setVisibility(GONE); //Anti flicker
    ...
    private float calculateCenterRawXofBubbleView() {
        if (isRtl) {
            ...
            return  mBubbleRadius/3 + mTrackLength * (mProgress - mMin) / mDelta;
        }
    }
...
//        }
    ...
    void config(CpBubbleConfigBuilder builder) {
        mMin = builder.min;
        mMax = builder.max;
    ...
    public CpBubbleConfigBuilder getConfigBuilder() {
        if (mConfigBuilder == null) {
            mConfigBuilder = new CpBubbleConfigBuilder(this);
        }
    ...
    public interface OnProgressChangedListener {
        ...
        void onProgressChanged(CpBubbleSeekBar bubbleSeekBar, int progress, float progressFloat);

        void getProgressOnActionUp(CpBubbleSeekBar bubbleSeekBar, int progress, float progressFloat);

        void getProgressOnFinally(CpBubbleSeekBar bubbleSeekBar, int progress, float progressFloat);
    }
...
//            canvas.drawPath(mBubblePath, mBubblePaint);
            ...
            Bitmap bitmapDraw = getBitmapDraw(getResources().getDrawable(R.drawable.ic_contract_airbubbles), dp2px(26));
            canvas.drawBitmap(bitmapDraw, x1, y1 - dp2px(6), mBubblePaint);
            ...
            float baseline = mBubbleRadius + (fm.descent - fm.ascent) / 2f+dp2px(9) ;
