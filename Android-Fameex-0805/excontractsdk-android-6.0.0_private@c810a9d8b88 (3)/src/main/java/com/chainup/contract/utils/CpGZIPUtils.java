...
public class CpGZIPUtils {
    public static final String GZIP_ENCODE_UTF_8 = "UTF-8";

    public static final String GZIP_ENCODE_ISO_8859_1 = "ISO-8859-1";

    /**
     *String is compressed into a GZIP byte array
     *
     * @param str
     * @return
     */
...
//System. out. println ("Decompressed string:"+StringUtils. newStringUtif8 (GZIPUtils. uncompress (GZIPUtils. compress (str)));
//System. out. println ("Decompressed string:"+GZIPUtils. uncompressToString (GZIPUtils. compress (str)));
//    }
