...
public class CpDateTime implements Serializable {
    ...
    /**
     * Instantiates {@link CpDateTime} from a {@link Date} and {@link TimeZone}.
     *
     * @param date date and time
     * @param zone time zone; if {@code null}, it is interpreted as {@code TimeZone.getDefault()}.
     */
    public CpDateTime(Date date, TimeZone zone) {
        this(false, date.getTime(), zone == null ? null : zone.getOffset(date.getTime()) / 60000);
    }

    /**
     * Instantiates {@link CpDateTime} from the number of milliseconds since the Unix epoch.
     *
     * <p>
     ...
     */
    public CpDateTime(long value) {
        this(false, value, null);
    }

    /**
     * Instantiates {@link CpDateTime} from a {@link Date}.
     *
     * <p>
     * The time zone is interpreted as {@code TimeZone.getDefault()}, which may vary with
     * implementation.
     ...
     */
    public CpDateTime(Date value) {
        this(value.getTime());
    }

    /**
     * Instantiates {@link CpDateTime} from the number of milliseconds since the Unix epoch, and a shift
     * from UTC in minutes.
     *
     * @param value number of milliseconds since the Unix epoch (January 1, 1970, 00:00:00 GMT)
     * @param tzShift time zone, represented by the number of minutes off of UTC.
     */
    public CpDateTime(long value, int tzShift) {
        this(false, value, tzShift);
    }

    /**
     * Instantiates {@link CpDateTime}, which may represent a date-only value, from the number of
     ...
     */
    public CpDateTime(boolean dateOnly, long value, Integer tzShift) {
    ...
    /**
     * Instantiates {@link CpDateTime} from an <a href='http://tools.ietf.org/html/rfc3339'>RFC 3339</a>
     * date/time value.
     *
     * <p>
     ...
     * @since 1.11
     */
    public CpDateTime(String value) {
        ...
        CpDateTime dateTime = parseRfc3339(value);
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CpDateTime)) {
            return false;
        }
        CpDateTime other = (CpDateTime) o;
     ...
     */
    public static CpDateTime parseRfc3339(String str) throws NumberFormatException {
        ...
        return new CpDateTime(!isTimeGiven, value, tzShiftInteger);
    }
