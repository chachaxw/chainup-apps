...
public final class CpPreferenceManager {
	...
	public static final String KLINETHEME_MODE = "klinethemeMode";
	...
	public static final String PREF_SHOW_CURRENT_CONTRACT = "ShowCurrentContract";
	public static final String PREF_SHOW_CURRENT_CONTRACT_CurrentEntrust = "ShowCurrentContractCurrentEntrust";
	public static final String PREF_SHOW_CURRENT_CONTRACT_PlanEntrust = "ShowCurrentContractPlanEntrust";
	public static final String CONTRACT_ORIGINAL_MARGIN_COIN_STR = "contract_original_margin_coin_str";
	...
	public static final String PREF_CONTRACT_ONLINE_STRING_TEXT = "OnlineStringText";
	...
	//Contract cloud sub account information
	...
	public static final String CONTRACT_INFO_URL_STR = "contract_info_url_str";
	...
	public static final String CONTRACT_KLINE_ORDER = "contract_kline_order";
	public static final String CONTRACT_INVITE_URL = "contract_invite_url";

	public static final String CONTRACT_COLLECT_COIN = "contract_collect_coin";
	public static final String CONTRACT_RATE = "contract_rate";
	//"The contract trading area chart display location (" "| - 1 | null) has not been set -------- 0 top 1 bottom"
	public static final String CONTEACT_KLINE_CHART_POSITIONSETTING = "contract_kline_chart_position_setting";
	//Set the contract trading area chart switch 0 off 1 on
	public static final String CONTEACT_KLINE_CHART_OFF = "contract_kline_chart_off";

	public static final String PREF_CONTRACT_COLOR = "ContractColor";

	//Contract Currency Pair Switching Dialog Record Last Selected Location
	public static final String CONTRACT_LEFTCOIN_TAB = "contract_leftcoin_tab_position";
	public static final String CONTRACT_KLINE_GUIDE_FLAG1 = "CONTRACT_KLINE_GUIDE_FLAG1";
	public static final String CONTRACT_LANGUAGE_JSON_LIST_STR = "contract_language_json_list_str";
