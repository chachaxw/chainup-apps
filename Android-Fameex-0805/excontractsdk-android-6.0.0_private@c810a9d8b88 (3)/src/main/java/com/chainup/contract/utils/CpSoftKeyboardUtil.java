...
/**
 * @Author lianshangljl
 * @Date 2019/6/1-9:20 AM
 * @Email buptjinlong@163.com
 * @description
 */
public class CpSoftKeyboardUtil {
    /**
     *Hide or show the soft keyboard
     *If it is now displayed, hide it after the call; otherwise, display it
     *
     * @param activity
     */
    ...
    public static boolean isSoftShowing(Activity activity) {
        ...
        //Get the bottom of the visible area of the View
        Rect rect = new Rect();
        //DecorView is the top-level view of the activity
        activity.getWindow().getDecorView().getWindowVisibleDisplayFrame(rect);
        //Considering the situation of the virtual navigation bar (in the case of the virtual navigation bar: screenHeight=rect.bottom+height of the virtual navigation bar)
    ...
    private static int getSoftButtonsBarHeight(Activity activity) {
        ...
        //This method obtains the height of a screen that may not be real
