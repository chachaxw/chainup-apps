 ...
 */
abstract class CpKScrollAndScaleView @JvmOverloads constructor(context: Context,
    ...
    /*Maximum value of scroll on the X-axis*/
    abstract fun getMaxScrollX(): Int

    /*Minimum value of rolling on the X-axis*/
