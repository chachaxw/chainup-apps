...
data class CpCoinMapBean(
       ...
       // @SerializedName("showCoinName")
        ...
        @SerializedName("newcoinFlag") val newcoinFlag: Int = 1, //0 main area 1 innovation area 2 observation area
        @SerializedName("depth_level") val depth_level: Int = 1, //Customize the depth type for saving currency pairs
