...
public  class LabelsViewV2 extends ViewGroup implements View.OnClickListener {
    ...
    public LabelsViewV2(Context context) {
        super(context);
        mContext = context;
    }

    public LabelsViewV2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        getAttrs(context, attrs);
    }

    public LabelsViewV2(Context context, AttributeSet attrs, int defStyleAttr) {
