...
public class ApkDownLoadResponseBody extends ResponseBody {
    private ResponseBody responseBody;
    private ApkDownloadListener downloadListener;
    private BufferedSource bufferedSource;
    public ApkDownLoadResponseBody(ResponseBody responseBody, ApkDownloadListener downloadListener) {
