...
package com.yjkj.chainup.zxing.camera.open;
...
public final class OpenCameraManager extends PlatformSupportManager<OpenCameraInterface> {
  ...
  public OpenCameraManager() {
    ...
    addImplementationClass(9, "com.chainup.wallet.android.features.zxing.camera.open.GingerbreadOpenCameraInterface");
  }
