...
class PwdSettingView @JvmOverloads constructor(context: Context,
    ...
    init {
        attrs?.let {
            ...
            resId = typedArray.getResourceId(R.styleable.PwdSettingView_icon_res, R.mipmap.login_eyeoff)
    ...
    fun initView(context: Context) {
        ...
        if (isShowPwd) {
            Utils.isShowPass(!hidePwd, iv_image, et_pwd)
