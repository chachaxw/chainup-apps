...
/**
 *Public information on contracts
 */
...
class ContractBean(
        ...
        var lastSymbol: String? = "",//This field belongs to the local field and is used to cancel the previous ws subscription
        @SerializedName("closePrice")
        var closePrice: String? = "",//This field belongs to the local field and is used to select the latest transaction price of the contract
        @SerializedName("rose")
        var rose: String? = "0.0"//This field belongs to the local field and is used to select the fluctuation range of the contract
