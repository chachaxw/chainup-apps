...
package com.yjkj.chainup.zxing.camera;
...
import com.yjkj.chainup.zxing.camera.open.OpenCameraManager;
...
public final class CameraManager {
  ...
  public synchronized Rect getFramingRect() {
    if (framingRect == null) {
      ...
      int topOffset = (screenResolution.y - height) / 2 - ViewUtil.INSTANCE.dpToPx(50f);
