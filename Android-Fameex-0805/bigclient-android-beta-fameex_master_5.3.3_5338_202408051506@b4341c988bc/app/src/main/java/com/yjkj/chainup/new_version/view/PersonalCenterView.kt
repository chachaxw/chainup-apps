...
class PersonalCenterView @JvmOverloads constructor(
    ...
    var showRightTv = false
        set(value) {
            field = value
            tv_right_title?.visibility = if(value) View.VISIBLE else View.GONE
        }
    ...
    init {
        attrs.let {
            ...
            rightIcon = typedArray.getResourceId(R.styleable.CustomPersonalTitle_personalRightIcon, R.mipmap.screening)
    ...
    fun initView(context: Context) {
        ...
        tv_right_title?.setSafeListener { if (listener != null) listener?.onclickRightIcon() }
    ...
    /**
     *Set authentication image
     *@param status 0 not certified 1 in certification 2 certified
     */
