...
import com.yjkj.chainup.util.toPx
import kotlinx.android.synthetic.main.base_toast_top_style.view.*
...
object ToastLayout {
    ...
    /**
     *Set the default background color for toast to orange
     *Color Resource ID
     */
    ...
    fun showToast(message: String) {
        show(ContextCompat.getColor(ChainUpApp.appContext, mColor), message, Toast.LENGTH_LONG)
    }
    ...
    private fun show(
        ...
        //Load toast layout
        val toastRoot = View.inflate(ChainUpApp.appContext, R.layout.base_toast_top_style, null)
...
//        if (toast == null) {
        toast = Toast(ChainUpApp.appContext)
//        }
