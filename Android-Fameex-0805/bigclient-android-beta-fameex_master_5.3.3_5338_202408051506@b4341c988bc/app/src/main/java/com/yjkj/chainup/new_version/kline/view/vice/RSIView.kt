...
//            text = view.formatValue(point.RSI)
            text = view.formatValue(if (mPricePrecision==-1) point.RSI else BigDecimalUtils.showSNormal(point.RSI.toString(),mPricePrecision).toFloat())+" "
