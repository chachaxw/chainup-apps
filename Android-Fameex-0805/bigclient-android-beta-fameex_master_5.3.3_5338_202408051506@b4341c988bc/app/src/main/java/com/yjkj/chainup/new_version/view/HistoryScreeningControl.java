...
public class HistoryScreeningControl {
    ...
    public void updateListener(Boolean status, int statusType, String symbolCoin, String symbolAndUnit, int tradingType, int priceType, String begin, String end) {
        for (int i = 0; i < listeners.size(); i++) {
            listeners.get(i).ConfirmationScreen(status, statusType, symbolCoin, symbolAndUnit, tradingType, priceType, begin, end);
        }
    }
