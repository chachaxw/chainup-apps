...
import com.yjkj.chainup.wedegit.DataPickView.adapters.WheelViewAdapter;
 ...
 */
public class WheelDateView extends View {
	...
	/**********Add a Boolean Tag to detect whether the Wheel is scrolling***************/
	 ...
	 * Constructor
	 */
	public WheelDateView(Context context, AttributeSet attrs, int defStyle) {
