 ...
 * Use the [RewardWithdrawalRecordFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RewardWithdrawalRecordFragment : NBaseFragment() {
    private val pageSize = 15
    private val adapter by lazy { RewardDetailAdapter(RewardDetailAdapter.withdrawalRecord) }
    ...
    override fun loadData() {
        super.loadData()
        addDisposable(getMainModel().getUserWithdrawRecords(consumer = object: NDisposableObserver(){
            override fun onResponseSuccess(jsonObject: JSONObject) {
                ...
                val optJSONArray = data.optJSONArray("list")
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = RewardWithdrawalRecordFragment()
    }
}