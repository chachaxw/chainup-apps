 ...
 * Use the [RewardRecordFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RewardRecordFragment : NBaseFragment() {
    private val pageSize = 15
    private val adapter by lazy { RewardDetailAdapter(RewardDetailAdapter.rewardRecord) }
    ...
    override fun loadData() {
        super.loadData()
        addDisposable(getMainModel().getUserRewardRecords(consumer = object: NDisposableObserver(){
    ...
    companion object {
        ...
        @JvmStatic
        fun newInstance() = RewardRecordFragment()
    }
}