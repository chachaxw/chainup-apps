...
public class BitmapUtils {
    ...
    /**
     *Obtain blurred background image
     *
     *@param activity Get blurred background activity
     ...
     *Screenshot
     *
     *@param activity screenshot of activity
    ...
    private static Bitmap startBlurBackground(Bitmap bkg) {
        ...
        float radius = 10; //Ambiguity level
     ...
     *Enlarge the image
     *
     *@param bitmap image that needs to be enlarged
     ...
     *Zoom Out Picture
     *
     *@param bitmap image that needs to be reduced
     ...
     *Blur the image
     *
     *@param sentBitmap requires blurry images
