...
data class OTCOrderBean(
    ...
    data class Order(
            ...
            @SerializedName("type") val type: String = "", //Selling
            @SerializedName("realName") val realName: String = "", //Selling
            ...
            @SerializedName("payCoin") val payCoin: String = "", //10.00000000
            ...
            @SerializedName("ctime") val ctime: Long = 0L, //1539916374000
            ...
            @SerializedName("status_text") val statusText: String = "", //Canceled
            @SerializedName("id") val id: Int, //11915
            @SerializedName("status") val status: Int, //4
            @SerializedName("originType") val originType: Int //1买 2卖
    )
}
