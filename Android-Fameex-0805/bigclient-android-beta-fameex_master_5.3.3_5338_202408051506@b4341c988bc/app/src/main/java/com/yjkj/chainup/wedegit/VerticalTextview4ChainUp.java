...
/**
 * @Author lianshangljl
 * @Date 2023/11/12-9:50 PM
 * @Email buptjinlong@163.com
 * @description
 */
public class VerticalTextview4ChainUp extends TextSwitcher implements ViewSwitcher.ViewFactory {
     ...
     */
    public void setText(float textSize, int padding, int textColor, boolean isBold) {
        mTextSize = textSize;
        mPadding = padding;
    ...
    public VerticalTextview4ChainUp(Context context) {
        this(context, null);
        mContext = context;
    }
    ...
    public VerticalTextview4ChainUp(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public View makeView() {
        ...
        if (isBold) {
            fontFamily = SystemV2Utils.Companion.getFontFamily();
        }
        t.setTypeface(fontFamily, fontStyle);
        t.setClickable(true);
