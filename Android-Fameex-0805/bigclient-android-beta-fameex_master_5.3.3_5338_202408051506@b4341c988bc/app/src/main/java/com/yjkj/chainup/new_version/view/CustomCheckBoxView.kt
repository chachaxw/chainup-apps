...
class CustomCheckBoxView @JvmOverloads constructor(
    ...
    var thirdContent = ""
    /**
     *Is only one TextView displayed
     */
    ...
    /**
     *Display only the Content of one centered TextView
     */
    var middleContent = ""
    /**
     *Display only one TextView color
     */
    var middleColor = ColorUtil.getColor(R.color.normal_text_color)
    /**
     *Display only one TextView font size
     */
    var middleSize = 0f
    ...
    /**
     *Prohibit TouchEvent from processing click events
     */
