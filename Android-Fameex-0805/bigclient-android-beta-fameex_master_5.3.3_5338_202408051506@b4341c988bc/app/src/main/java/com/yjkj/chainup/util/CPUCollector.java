...
public class CPUCollector {
    ...
    private int maxFrameCount = 5; //The total number of statistics, modifiable
    private int resultFrameTimes = 0; //Number of statistics
    ...
    /**
     *Executable multi line command (bat)
     *
     * @param commands
     * @return
     */
