...
object DataManager {
    ...
    /**
     *Calculate RSI
     *RSI generally takes a 14 day cycle.
...
//            macd = (dif - dea) *2f//pm makes it unnecessary * 2
            macd = (dif - dea)
            point.DIF = dif
            point.DEA = dea
            point.MACD = macd
    ...
    /**
     *Calculating BOLL needs to be done after calculating ma
     *
     * @param dataList
     */
