...
data class CashFlowBean(
    ...
    data class Finance(
            ...
            @SerializedName("status_text") val statusText: String = "", //Completed
            ...
            @SerializedName("transactionType") val transactionType: Int = 0, //1. Transfer to off-site, 2. Transfer to off-site
            @SerializedName("transactionType_text") val transactionType_text: String = "", //1. Transfer to off-site, 2. Transfer to off-site
            @SerializedName("type_text") val type_text: String = "" //1. Transfer to off-site, 2. Transfer to off-site


    ){
        fun getTranCreateTime(): String {
            return DateUtils.getYearMonthDayHourMinSecond(createdAtTime)
        }

        fun getWalletCreateTime(): String {
            return DateUtils.getYearMonthDayHourMinSecond(createdAtTime)
        }
    }
