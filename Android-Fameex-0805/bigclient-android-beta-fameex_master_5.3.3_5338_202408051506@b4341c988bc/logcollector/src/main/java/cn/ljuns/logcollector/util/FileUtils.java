...
public class FileUtils {
    ...
    private static File createCacheFile(String path, String fileName, boolean cleanCache) {
        ...
        //Do you want to delete the cache log file
        if (cleanCache) {
     ...
     * @return FileDir
     */
    public static String getCacheFileDir(Context context, String dirName) {
        String name = "/" + dirName;
    ...
    public static void clearFile(String fileName) {
        if (fileName != null) {
            ...
            File logZip = new File(fileName + ".zip");
            for (File file : directory.listFiles()) {
                file.delete();
            }
            logZip.delete();
     ...
     * @return FileDir
     */
    public static String getShareFileDir(String dirName) {
        String filePath = "";
        if (Build.BRAND.equals("Xiaomi")) {
            filePath = Environment.getExternalStorageDirectory().getPath() + "/DCIM/Camera/" + dirName + File.separator;
        } else {
            filePath = Environment.getExternalStorageDirectory().getPath() + "/DCIM/" + dirName + File.separator;
        }
