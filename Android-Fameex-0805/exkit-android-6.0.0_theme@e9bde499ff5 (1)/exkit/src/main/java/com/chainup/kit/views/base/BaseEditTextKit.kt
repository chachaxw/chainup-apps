 ...
 * @property isSearch
 * */
open class BaseEditTextKit @JvmOverloads constructor(
...
//        textSize = resources.getDimensionPixelSize(R.dimen.sp_5).toFloat()
        ...
        Log.d("BaseEditKit","initView ${height}")
        initBg()
    ...
    private fun initIcon(){
        icClearImg = ContextCompat.getDrawable(context,R.mipmap.public_deleteall)!!
        icSearchImg = ContextCompat.getDrawable(context,R.mipmap.public_search)!!
...
//        Log.d("onTextChanged","text:$text")
    ...
    private fun updateIconVisible(iconClearVisible: Boolean,visibleIcon:Boolean = false) {
        ...
        compoundDrawablePadding = PublicSizeUtil.dp2px(context,8.0f)
    }
