...
public abstract class KKRefreshAbstract<T extends KKRefreshAbstract<?>> extends SimpleComponent implements RefreshComponent {
    ...
    public KKRefreshAbstract(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        }
        ...
        return mFinishDuration;//Rebound after a delay of 500 milliseconds
    }
...
//    /**
//     *@ deprecated uses findViewById (ID_IMAGE_ARROW) instead
//     */
//    @Deprecated
...
//
//    /**
//     *@ deprecated uses findViewById (ID_IMAGE_PROGRESS) instead
//     */
//    @Deprecated
...
//
//    /**
//     *@ deprecated uses findViewById (ID_TEXT_TITLE) instead
//     */
//    @Deprecated
