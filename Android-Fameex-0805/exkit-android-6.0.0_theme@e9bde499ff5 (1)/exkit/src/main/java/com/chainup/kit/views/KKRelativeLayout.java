...
public class KKRelativeLayout extends KKAlphaRelativeLayout implements IQMUILayout {
    private QMUILayoutHelper mLayoutHelper;

    public KKRelativeLayout(Context context) {
        super(context);
        init(context, null, 0);
    }

    public KKRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public KKRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
