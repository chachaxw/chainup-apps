...
/**
 *Classic pull-up bottom
 * Created by scwang on 2017/5/28.
 */
@SuppressWarnings({"unused", "UnusedReturnValue"})
public class KKRefreshFooter extends KKRefreshAbstract<KKRefreshFooter> implements RefreshFooter {
    ...
    public KKRefreshFooter(Context context) {
        this(context, null);
    }

    public KKRefreshFooter(Context context, AttributeSet attrs) {
        super(context, attrs, 0);

        View.inflate(context, R.layout.kk_refresh_footer, this);
...
//        }
        ...
        if (ta.hasValue(R.styleable.ClassicsFooter_srlTextSizeTitle)) {
            mTitleText.setTextSize(TypedValue.COMPLEX_UNIT_PX, ta.getDimensionPixelSize(R.styleable.ClassicsFooter_srlTextSizeTitle, SmartUtil.dp2px(12)));
        }
...
//    }
    ...
    public int onFinish(@NonNull RefreshLayout layout, boolean success) {
        /*
         *Fix bugs on May 15th, 2020
         * https://github.com/scwang90/SmartRefreshLayout/issues/1003
         *After fixing that there is no more data, loading is still displaying the issue
         */
    ...
    /**
     *@param colors corresponds to the srlPrimaryColor srlAccentColor configured in Xml
     *@ deprecated is only called by the framework
     *User uses {@ link RefreshLayout # setPrimaryColorsId (int...)}
     */
    @Override
    @Deprecated
    ...
    /**
     *Once all data has been loaded, the loading function cannot be triggered again
     */
    @Override
