...
@Deprecated("this adapter with showBottomSheetList has a bug!",ReplaceWith("KKBottomSheetRvAdapterV2"))
open class KKBottomSheetRvAdapter(data: ArrayList<KKItemTabInfo>, var position: Int) : BaseQuickAdapter<KKItemTabInfo, BaseViewHolder>(
