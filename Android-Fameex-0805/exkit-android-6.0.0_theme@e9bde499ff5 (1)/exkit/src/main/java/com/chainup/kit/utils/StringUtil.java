...
public class StringUtil {
    ...
    public static boolean checkStrOrZero(String str) {
        return checkStr(str) && !str.equals("--");
    }

    public static boolean isPayment(String str,String regMessage) {
        Pattern p = Pattern.compile(regMessage);
        Matcher m = p.matcher(str);
        return m.find();
    }
}
