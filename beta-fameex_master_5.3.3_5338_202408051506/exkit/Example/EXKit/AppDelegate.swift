...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        appearance.tableHeaderView = UIView(frame: CGRect(x: 0, y: 0, width: Device_W, height: CGFLOAT_MIN))
        appearance.tableFooterView = UIView(frame: CGRect(x: 0, y: 0, width: Device_W, height: CGFLOAT_MIN))
        appearance.estimatedRowHeight = 0
        appearance.estimatedSectionHeaderHeight = 0
        appearance.estimatedSectionFooterHeight = 0
