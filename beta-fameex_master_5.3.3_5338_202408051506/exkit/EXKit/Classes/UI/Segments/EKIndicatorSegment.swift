...
class EKContractIndicatorCell:JXSegmentedTitleCell {
}


public class EKContractIndicatorSegmentDatasource: JXSegmentedTitleDataSource {
    
    public override func registerCellClass(in segmentedView: JXSegmentedView) {
        segmentedView.collectionView.register(EKContractIndicatorCell.self, forCellWithReuseIdentifier: "EKContractIndicatorCell")
    }
    
    public override func segmentedView(_ segmentedView: JXSegmentedView, cellForItemAt index: Int) -> JXSegmentedBaseCell {
        let cell = segmentedView.dequeueReusableCell(withReuseIdentifier: "EKContractIndicatorCell", at: index)
        return cell
    }
