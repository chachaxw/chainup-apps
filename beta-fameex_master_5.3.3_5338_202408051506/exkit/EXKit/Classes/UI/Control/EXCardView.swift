...
open class EXCardView: UIControl, EXSelectable {
    ...
    override init(frame: CGRect) {
        ...
        selectableUpdater = EXViewStateUpdater(dynamicUpdater: { [weak self] isSelected in
            ...
            self.normalCheckmarkImageView.image = isSelected ? EXKitBundle.svgImage(named: "public_selecteds") : nil
            self.inlineCheckmarkImageView.image = isSelected ? EXKitBundle.svgImage(named: "public_checked")  : nil
