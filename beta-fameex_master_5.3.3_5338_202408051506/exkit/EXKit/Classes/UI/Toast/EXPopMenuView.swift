...
public class PopMenuItem: NSObject{
    ...
    var tilteFont: UIFont = UIFont.Ex.medium(14)
...
public class EXPopMenuView: UIView {
    ...
    lazy var containerView : EXStackView = {
    ...
    public func pop(fromView:UIView,acionItem:[PopMenuItem], callBack: @escaping ClickViewBlock, customConfigurationBlock:((EXPopover)->Void)? = nil){
        ...
        // need update when theme changed
        containerView.separatorConfiguration = .init(color: .Ex.fill4,
                                                     width: 0.5,
                                                     height: btnH + topBottomMargin * 2,
                                                     cornerRadius: 0)
        self.show = true
...
public class PopGuideItem : NSObject{
    ...
    public var textColor: UIColor = .Ex.text4
    public var tilteFont: UIFont = .Ex.medium(14)
    public var subtitleFont: UIFont = .Ex.medium(12)
...
public class EXPopGuidManger{
    ...
    lazy var pop: EXPopover = {
        ...
        popover.popoverColor = .Ex.main1 //UIColor.ThemeView.highlight
        return popover
    }()
...
class EXPopGuidItemView: UIView {
    ...
    lazy var titleLabel: UILabel = {
        let label = UILabel(text:"", font: .Ex.medium(14), textColor: .Ex.text2, alignment: .left)
    ...
    lazy var subTitleLabel: UILabel = {
        let label = UILabel(text:"", font: .Ex.medium(12), textColor: .Ex.text2, alignment: .right)
        label.numberOfLines = 0
