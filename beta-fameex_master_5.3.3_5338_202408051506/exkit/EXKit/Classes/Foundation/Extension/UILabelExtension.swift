...
extension UILabel{
    ...
    public convenience init(text: String? = nil, frame: CGRect = .zero, font: UIFont?, textColor: UIColor?, alignment: NSTextAlignment = .left, numberOfLines:Int? = nil, preferredMaxLayoutWidth:CGFloat? = nil) {
        self.init()
