...
extension UIButton {
    public convenience init(buttonType: UIButton.ButtonType = .custom, title: String? = nil, titleFont: UIFont?, titleColor: UIColor?) {
    ...
    public convenience init(buttonType: UIButton.ButtonType = .custom, image: UIImage?, hightlightedImage: UIImage? = nil, imageContentMode: UIView.ContentMode = .scaleAspectFit) {
        self.init(type: buttonType)
        if image != nil {
            self.setImage(image, for: .normal)
        }
