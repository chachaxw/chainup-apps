...
class DatePickerModel extends CommonPickerModel {
  ...
  DatePickerModel(
    ...
    _currentLeftIndex = this.currentTime.month - minMonth;
    _currentMiddleIndex = this.currentTime.day - minDay;
  ...
  void setCurrentTime(DateTime newTime) {
    ...
    int minMonth = _minMonthOfCurrentYear();
    int minDay = _minDayOfCurrentMonth();
    _currentLeftIndex = currentTime.month - minMonth;
    _currentMiddleIndex = currentTime.day - minDay;
    _currentRightIndex = currentTime.year - minTime.year;

    setLeftIndex(_currentLeftIndex);
    setMiddleIndex(_currentMiddleIndex);
    setRightIndex(_currentRightIndex);
  }
  ...
  void _fillLeftLists() {
    ...
    leftList = List.generate(maxMonth - minMonth + 1, (int index) {
  ...
  void _fillMiddleLists() {
    ...
    int minDay = _minDayOfCurrentMonth();
    middleList = List.generate(maxDay - minDay + 1, (int index) {
