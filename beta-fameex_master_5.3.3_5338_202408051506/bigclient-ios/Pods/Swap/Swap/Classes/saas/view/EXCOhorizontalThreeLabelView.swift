...
enum EXCOhorizontalThreeLabelViewUser {
    case header
    case cell
}

class EXCOhorizontalThreeLabelView: UIView {

    func getLabel(user:EXCOhorizontalThreeLabelViewUser) -> UILabel {
        let label = UILabel()
    ...
    init(user:EXCOhorizontalThreeLabelViewUser) {
