...
-(BOOL)isTelephoneNumber{
    ///八位或11位数字 座机号码 English: /Eight or 11 digit landline number
 ...
 *font : 该字符串所用的字体(字体大小不一样,显示出来的面积也不同) English: *Font: The font used for this string (different font sizes result in different displayed areas)
 */
...
+(NSString *)roundUpFloorfNum:(CGFloat )num unit:(NSString *)unit{
    ...
    if (num < 1000) {
        ...
        // 点的位置 English: Location of points
        NSUInteger ponitLoc = [fStr rangeOfString:@"."].location;
        // 需要改变的区间 English: Interval that needs to be changed
