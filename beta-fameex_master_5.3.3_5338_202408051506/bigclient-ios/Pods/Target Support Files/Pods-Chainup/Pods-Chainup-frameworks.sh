...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/App.framework"
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/connectivity.framework"
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/device_info_plus.framework"
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/Flutter.framework"
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/fluttertoast.framework"
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/package_info.framework"
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/path_provider_foundation.framework"
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/sqflite.framework"
  install_framework "${PODS_ROOT}/EXFlutterKLineKit/Frameworks/Toast.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXKit/EXKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/EXLookin/EXLookin.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Swap/Swap.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftDraw/SwiftDraw.framework"
