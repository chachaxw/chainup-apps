...
public extension EXTextViewProtocol where Self:UIView {
    ...
    var attributedTextDidChangeSignal: Observable<NSAttributedString?> { textView.rx.attributedText.asObservable().distinctUntilChanged() }
    ///
//    var didChangeSignal: Observable<Void> { textView.rx.didChange.asObservable() }
//    var didChangeSelectionSignal: Observable<Void> { textView.rx.didChangeSelection.asObservable() }
    ///
    var editingDidBeginSignal: Observable<Void> { textView.rx.didBeginEditing.asObservable() }
    var editingDidEndSignal: Observable<Void> { textView.rx.didEndEditing.asObservable() }
}
