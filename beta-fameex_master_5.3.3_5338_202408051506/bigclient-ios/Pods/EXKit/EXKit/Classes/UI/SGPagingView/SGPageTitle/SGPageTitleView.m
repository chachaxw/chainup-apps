...
//  SGPagingViewExample
//
//  Copyright ©2020年 kingsic. All rights reserved.
//
...
- (void)addBadgeForIndex:(NSInteger)index {
    [self addBadgeForIndex:index color:nil];
}
- (void)addBadgeForIndex:(NSInteger)index color:(UIColor *)color{
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.02 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        badge.layer.backgroundColor = (color ?: self.configure.badgeColor).CGColor;
