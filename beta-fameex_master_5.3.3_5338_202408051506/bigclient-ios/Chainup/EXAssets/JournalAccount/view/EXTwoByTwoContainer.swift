...
class EXTwoByTwoItemModel:NSObject {
    ...
    var ltitleFont:UIFont = UIFont.ThemeFont.BodyBold
    var rtitleFont:UIFont = UIFont.ThemeFont.BodyBold
...
class EXTwoByTwoContainer: UIView {
    ...
    func bindContainers(_ items:[EXTwoByTwoItemModel],addBlock:Bool = false ) {
        ...
        for (_,item) in items.enumerated() {
            ...
            twoByTwoView.leftTopLabel.font = item.ltitleFont
            twoByTwoView.rightTopLabel.font = item.rtitleFont
