...
@objcMembers class NavCustomVC: BaseVC , UIGestureRecognizerDelegate {
    ...
    var navtype = NavType.normal
    {
        didSet{
            ...
            case .list:
                ...
                navCustomView.middleTitle.font = .Ex.medium(28)
            case .listtitle:
                navCustomView.middleTitle.snp.remakeConstraints { (make) in
    ...
    //MARK: Set title
    public func setTitle(_ title: String , color: UIColor = .Ex.text1 , font: UIFont = .Ex.medium(18)){
        navCustomView.middleTitle.text = title
        navCustomView.middleTitle.textColor = color
        navCustomView.middleTitle.font = font
    }
