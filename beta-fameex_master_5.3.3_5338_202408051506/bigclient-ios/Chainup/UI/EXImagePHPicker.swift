...
typealias PHPickerSuccess = (_ image:UIImage)  -> Void

@available(iOS 14, *)
class EXImagePHPicker: NSObject {
    ...
    func selectImageFromAlbumSuccess(_ closure:@escaping PHPickerSuccess, Fail failClosure:(() -> Void)? = nil){
...
EXAlert. showFail (msg: "Recognition failed")
        })
    }
}
