...
class EXLeverEntrustVC: NavCustomVC {
    ...
    lazy var currentVC: EXLeverageCurrentVC = {
        let vc = EXLeverageCurrentVC()
        vc.view.isHidden = false
        return vc
    }()
    
    lazy var historyVC: EXLeverageHistoryVC = {
...
extension EXLeverEntrustVC: JXSegmentedViewDelegate {
