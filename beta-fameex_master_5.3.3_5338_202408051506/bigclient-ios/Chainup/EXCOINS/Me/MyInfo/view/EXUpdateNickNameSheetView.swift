//
//  EXUpdateNickNameSheetView.swift
//  Chainup
//
...
class EXUpdateNickNameSheetView: UIView {
    ...
    lazy var titleLabel: UILabel = {
        let v = UILabel(text: "personal_text_setNickname".localized(),font: .Ex.medium(16), textColor: .Ex.text1)
        return v
    }()
    ...
    lazy var codeTextField: EXBasicTextField = {
        ...
        v.placeholder = "hint_nickname".localized()
        v.maxLength = 10
        return v
    }()
    ...
    func errorTipShowMsg(errmsg: String) {
        codeTextField.showBorderLayerError()
